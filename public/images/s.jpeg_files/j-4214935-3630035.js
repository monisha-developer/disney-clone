//Generated:2021-11-03 16:49:29// 6-252
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4214935 || '',
    guid: window.ftGUID_4214935 || '',
    confID: window.ftConfID_4214935 || '0',
    ftReturn: window.ftReturn_4214935 || '',
    keyword: window.ftKeyword_4214935 || '',
    ftId: window.ftId_4214935 || '',
    ftImpId: window.ftImp4214935 && window.ftImp4214935.impID || '',
    gdpr: window.ftImp4214935 && window.ftImp4214935.gdpr || '',
    gdpr_consent: window.ftImp4214935 && window.ftImp4214935.gdpr_consent || '',
    gdpr_pd: window.ftImp4214935 && window.ftImp4214935.gdpr_pd || '',
    us_privacy: window.ftImp4214935 && window.ftImp4214935.us_privacy || '',
    campaignID: '115843',
    cID: '151898',
    pID: '4214935',
    creativeID: '3630035',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115843&sid=18330&plc=4214935&num=&adid=&advid=&adsrv=29&btreg=4214935&btadsrv=flashtalking&crt=3630035&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"
    ],
    clickTags: ["http://servedby.flashtalking.com/click/8/115843;4214935;3630035;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/in/creativecloud/plans.html?plan=individual&sdid=GZKZY1B7&mv=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?214973145-4214935;3630035;',
    centreAd: false,
    width: 300,
    height: 250,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/421/4214935/3630035/image/3630035.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/115843;4214935;202;pixel;DV360;DV360FY20CCPSPAudExINDSKBAN300x250/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref: "http://servedby.flashtalking.com/click/8/115843;4214935;3630035;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/in/creativecloud/plans.html?plan=individual&sdid=GZKZY1B7&mv=display",
    divID: 'ftdiv4214935',
    altimgID: 'ftalt4214935',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4214935 && parseInt(window.ftImp4214935.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4214935') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4214935'),
    pageVisible: 'maybe',
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4214935").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4214935").style.display = "none";
		    }
		});
	}
}(ft4214935));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115843&l2=DV360&l3=4214935&l4=3630035&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115843&l2=DV360&l3=4214935&l4=3630035&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
