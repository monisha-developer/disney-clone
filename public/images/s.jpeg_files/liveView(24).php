...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=107674&playerApiId=primisPlayer&cbuster=1637244100',
					origQString: 's=107674&playerApiId=primisPlayer',
					placementId: 107674,
					x: 600,
					y: 400,
					videoType: 'flow',
					...
					allowedUtmParameters: ["utm_source","utm_medium","tum_campaign","utm_content","utm_term"],
